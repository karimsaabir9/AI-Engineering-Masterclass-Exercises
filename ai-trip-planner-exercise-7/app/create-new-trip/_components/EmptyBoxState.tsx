  ...
  return (
    <div className="mt-2">
      <h2 className="font-bold text-xl lg:text-2xl text-center">
        Start Planning new <strong className="text-secondary">Trip</strong> using
        AI
      </h2>
      ...
      <div className="flex flex-col justify-center gap-2 mt-3">
        {suggestions.map((suggestion, index) => (
          <div
            ...
            className="flex items-center gap-2 border rounded-xl p-2.5 cursor-pointer hover:border-secondary hover:text-secondary"
          >
            {suggestion.icon}
